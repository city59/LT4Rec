...
def parse_args():
    parser = argparse.ArgumentParser(description="LT4Rec")

    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="music", help="Choose a dataset:[music, movie, book, food]")
    parser.add_argument(
    ...
    parser.add_argument('--Ks', nargs='?', default='[1, 5, 10, 20, 40]', help='Output sizes of every layer')
